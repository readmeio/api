...
export default class SDK {
   ...
   *
   */
  post<T = unknown>(path: string, body: AddPetBodyParam): Promise<T>;
  /**
   ...
   *
   */
  post(path: string, body: UploadFileBodyParam, metadata: UploadFileMetadataParam): Promise<UploadFile_Response_200>;
  /**
   * Uploads an image
   *
   */
  post(path: string, metadata: UploadFileMetadataParam): Promise<UploadFile_Response_200>;
  /**
   * Place an order for a pet
   *
   */
  post(path: string, body: PlaceOrderBodyParam): Promise<PlaceOrder_Response_200>;
  /**
   * This can only be done by the logged in user.
   *
   * @summary Create user
   */
  post<T = unknown>(path: string, body: CreateUserBodyParam): Promise<T>;
  /**
   ...
   *
   */
  put<T = unknown>(path: string, body: UpdatePetBodyParam): Promise<T>;
  /**
   * This can only be done by the logged in user.
   *
   * @summary Updated user
   */
  put<T = unknown>(path: string, body: UpdateUserBodyParam, metadata: UpdateUserMetadataParam): Promise<T>;
  /**
   ...
   */
  get(path: string, metadata: GetPetByIdMetadataParam): Promise<GetPetById_Response_200>;
  /**
   ...
   */
  get(path: string, metadata: GetOrderByIdMetadataParam): Promise<GetOrderById_Response_200>;
  /**
   ...
   *
   */
  get(path: string, metadata: GetUserByNameMetadataParam): Promise<GetUserByName_Response_200>;
  /**
   ...
   *
   */
  addPet<T = unknown>(body: AddPetBodyParam): Promise<T> {
   ...
   *
   */
  updatePet<T = unknown>(body: UpdatePetBodyParam): Promise<T> {
   ...
   * @summary Find pet by ID
   */
  getPetById(metadata: GetPetByIdMetadataParam): Promise<GetPetById_Response_200> {
   ...
   *
   */
  uploadFile(body: UploadFileBodyParam, metadata: UploadFileMetadataParam): Promise<UploadFile_Response_200>;
  /**
   * Uploads an image
   *
   */
  uploadFile(metadata: UploadFileMetadataParam): Promise<UploadFile_Response_200>;
  /**
   * Uploads an image
   *
   */
   ...
   *
   */
  placeOrder(body: PlaceOrderBodyParam): Promise<PlaceOrder_Response_200> {
   ...
   * @summary Find purchase order by ID
   */
  getOrderById(metadata: GetOrderByIdMetadataParam): Promise<GetOrderById_Response_200> {
   ...
   * @summary Create user
   */
  createUser<T = unknown>(body: CreateUserBodyParam): Promise<T> {
   ...
   *
   */
  getUserByName(metadata: GetUserByNameMetadataParam): Promise<GetUserByName_Response_200> {
   ...
   * @summary Updated user
   */
  updateUser<T = unknown>(body: UpdateUserBodyParam, metadata: UpdateUserMetadataParam): Promise<T> {
...
export interface AddPetBodyParam {
  id?: number;
  category?: {
    id?: number;
    name?: string;
...
export interface UpdatePetBodyParam {
  id?: number;
  category?: {
    id?: number;
    name?: string;
...
export type FindPetsByStatus_Response_200 = {
  id?: number;
  category?: {
    id?: number;
    name?: string;
...
export type FindPetsByTags_Response_200 = {
  id?: number;
  category?: {
    id?: number;
    name?: string;
...
export interface GetPetById_Response_200 {
  id?: number;
  category?: {
    id?: number;
    name?: string;
...
export interface UploadFile_Response_200 {
  code?: number;
  type?: string;
  message?: string;
  [k: string]: unknown;
...
export interface PlaceOrderBodyParam {
  id?: number;
  petId?: number;
  quantity?: number;
  shipDate?: string;
...
export interface PlaceOrder_Response_200 {
  id?: number;
  petId?: number;
  quantity?: number;
  shipDate?: string;
...
export interface GetOrderById_Response_200 {
  id?: number;
  petId?: number;
  quantity?: number;
  shipDate?: string;
...
export interface CreateUserBodyParam {
  id?: number;
  username?: string;
  firstName?: string;
  lastName?: string;
...
export type CreateUsersWithArrayInputBodyParam = {
  id?: number;
  username?: string;
  firstName?: string;
  lastName?: string;
...
export type CreateUsersWithListInputBodyParam = {
  id?: number;
  username?: string;
  firstName?: string;
  lastName?: string;
...
export interface GetUserByName_Response_200 {
  id?: number;
  username?: string;
  firstName?: string;
  lastName?: string;
...
export interface UpdateUserBodyParam {
  id?: number;
  username?: string;
  firstName?: string;
  lastName?: string;
