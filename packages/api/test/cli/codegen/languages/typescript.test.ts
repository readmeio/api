...
describe('typescript', () => {
  ...
  describe('#generator', () => {
    it(
      ...
      assertSDKFixture('@api/test-utils/src/fixtures/definitions/simple.json', 'simple-ts'),
    );

    it(
      'should be able to generate valid TS when a body is optional but metadata isnt',
      assertSDKFixture('@api/test-utils/src/fixtures/definitions/optional-payload.json', 'optional-payload'),
    );
    ...
    it(
      ...
      assertSDKFixture('@api/test-utils/src/fixtures/definitions/operationid-quirks.json', 'operationid-quirks'),
    );

    it(
      'should handle `title` props that start with a number',
      assertSDKFixture('@api/test-utils/src/fixtures/definitions/response-title-quirks.json', 'response-title-quirks'),
    );
    ...
    it(
      ...
      assertSDKFixture('@api/test-utils/src/fixtures/definitions/alby.json', 'alby'),
    );

    describe('javascript generation', () => {
      it(
        'should generate a CommonJS library',
        assertSDKFixture('@api/test-utils/src/fixtures/definitions/simple.json', 'simple-js-cjs', { outputJS: true }),
      );

      it(
        'should generate am ESM library',
        assertSDKFixture('@api/test-utils/src/fixtures/definitions/simple.json', 'simple-js-esm', {
          outputJS: true,
          compilerTarget: 'esm',
        }),
      );
