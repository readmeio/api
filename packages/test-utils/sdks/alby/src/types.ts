...
export type PatchAppsAppIdKeysKeyIdBodyParam = FromSchema<typeof schemas.PatchAppsAppIdKeysKeyId.body>;
export type PatchAppsAppIdKeysKeyIdMetadataParam = FromSchema<typeof schemas.PatchAppsAppIdKeysKeyId.metadata>;
export type PatchAppsAppIdNamespacesNamespaceIdBodyParam = FromSchema<typeof schemas.PatchAppsAppIdNamespacesNamespaceId.body>;
...
export type PatchAppsAppIdRulesRuleIdBodyParam = FromSchema<typeof schemas.PatchAppsAppIdRulesRuleId.body>;
export type PatchAppsAppIdRulesRuleIdMetadataParam = FromSchema<typeof schemas.PatchAppsAppIdRulesRuleId.metadata>;
export type PatchAppsIdBodyParam = FromSchema<typeof schemas.PatchAppsId.body>;
export type PatchAppsIdMetadataParam = FromSchema<typeof schemas.PatchAppsId.metadata>;
export type PostAccountsAccountIdAppsBodyParam = FromSchema<typeof schemas.PostAccountsAccountIdApps.body>;
export type PostAccountsAccountIdAppsMetadataParam = FromSchema<typeof schemas.PostAccountsAccountIdApps.metadata>;
export type PostAppsAppIdKeysBodyParam = FromSchema<typeof schemas.PostAppsAppIdKeys.body>;
...
export type PostAppsAppIdNamespacesBodyParam = FromSchema<typeof schemas.PostAppsAppIdNamespaces.body>;
export type PostAppsAppIdNamespacesMetadataParam = FromSchema<typeof schemas.PostAppsAppIdNamespaces.metadata>;
export type PostAppsAppIdQueuesBodyParam = FromSchema<typeof schemas.PostAppsAppIdQueues.body>;
export type PostAppsAppIdQueuesMetadataParam = FromSchema<typeof schemas.PostAppsAppIdQueues.metadata>;
export type PostAppsAppIdRulesBodyParam = FromSchema<typeof schemas.PostAppsAppIdRules.body>;
export type PostAppsAppIdRulesMetadataParam = FromSchema<typeof schemas.PostAppsAppIdRules.metadata>;
export type PostAppsIdPkcs12BodyParam = FromSchema<typeof schemas.PostAppsIdPkcs12.body>;
